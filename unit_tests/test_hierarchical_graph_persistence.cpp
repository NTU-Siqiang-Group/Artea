...
// ============================================================
//  DataProvider singleton (lazy: dataset + auto-probed L0 minimum distance)
// ============================================================
...
public:
    ...
    void init() {
        ...
        // independent; the metric-dependent prober / build_dist live behind
...
protected:
        ...
        -> std::unique_ptr<compact::hierarchical_graph_t>
    {
        ...
        return build_infra_dispatch(provider.get_dataset_info(), ARTEA_METRIC_LAMBDA(std::unique_ptr<compact::hierarchical_graph_t>) {
            // Stateless functor: the dimension is a compile-time trait now.
            dist_func_t<Metric, Dim> build_dist;

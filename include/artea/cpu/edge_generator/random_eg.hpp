...
public:
    ...
    /**
     * @brief Generate random edges for a flat graph.
     * @param flat_graph The graph to initialize with random edges.
    ...
    auto generate(
        ...
        const vector_array_t& vecs_data = flat_graph.get_vecs_data();

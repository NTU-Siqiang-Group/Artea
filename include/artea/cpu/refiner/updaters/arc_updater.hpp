...
class ARCUpdater :
    public RefinerTraitsT::template neighbor_updater_t<DistFuncT, ARCUpdater<RefinerTraitsT, DistFuncT>> {
    ...
    using base_class_t     = typename RefinerTraitsT::template neighbor_updater_t<DistFuncT, ARCUpdater<RefinerTraitsT, DistFuncT>>;

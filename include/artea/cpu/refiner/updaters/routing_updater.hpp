...
class RoutingUpdater :
    public RefinerTraitsT::template neighbor_updater_t<DistFuncT, RoutingUpdater<RefinerTraitsT, DistFuncT>>
{
    ...
    using router_t = typename RefinerTraitsT::template single_layer_router_t<DistFuncT>;
    using refining_graph_t = typename RefinerTraitsT::dynamic::refining_graph_t;
    using base_class_t = typename RefinerTraitsT::template neighbor_updater_t<DistFuncT, RoutingUpdater<RefinerTraitsT, DistFuncT>>;

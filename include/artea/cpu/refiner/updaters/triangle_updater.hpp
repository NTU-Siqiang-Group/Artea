...
class TriangleUpdater :
    public RefinerTraitsT::template neighbor_updater_t<DistFuncT, TriangleUpdater<RefinerTraitsT, DistFuncT>> {
    ...
    using base_class_t = typename RefinerTraitsT::template neighbor_updater_t<DistFuncT, TriangleUpdater<RefinerTraitsT, DistFuncT>>;

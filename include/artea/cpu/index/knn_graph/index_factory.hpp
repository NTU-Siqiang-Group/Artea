...
private:
    ...
    static auto _build_loop(
        ...
        // knn_graph dropped PruningConfig in a prior commit; pass plain
        // RNG coefficients (scale=1, shift=0) to preserve the ori_dist
        // threshold TriangleUpdater used before gaining these params.
